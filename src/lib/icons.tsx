/**
 * @fileoverview Centralized SVG icon components
 * @description Eliminates duplicate icon definitions and removes lucide-react dependency
 */
...
/** Right arrow for navigation forward */
