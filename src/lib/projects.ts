...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "ssir-module",
    description:
      "A Python module for simulating the spread of disease in a grid-based population. Built with C++11, pybind11 and CMake.",
  ...
  },
  {
    ...
    title: "pomodoro-50",
    description:
      "A Flask-powered Pomodoro web app with session and database management, AI integration, user authentication and customizable timers, and productivity tracking.",
